...
class SteamMarket(commands.Cog):
    ...
    async def getitemprice(self, ctx: discord.Interaction, *, name: str, appid: int = 730, wear: str = ""):
        async with aiohttp.ClientSession() as session:
            url = f"http://127.0.0.1:8002/marketplace/{appid}?item={urllib.parse.quote_plus(name+wearParser(wear))}&fill=true&unquote=true"
